          ...
          <div style={styles.headerActions} className="header-actions">
            ...
            <div style={styles.profile} className="header-profile">
              <div style={styles.profileText} className="header-profile-text">
                <p style={styles.userName}>Dentist</p>
            ...
            <div style={styles.rightCol}>
              <div style={styles.listHeader}>
                ...
                <button
                  ...
                  onClick={() => navigate('/dentist/booking')}
                >
              ...
              <div className="appointment-list-scrollable">
                {loading ? (
                  ...
                  <p style={{ color: "#666", padding: "20px 0" }}>No appointments found for this selection.</p>
                ) : (
                    ...
                    return (
                      ...
                      >
                        <div style={styles.appMain}>
                          {/* Card Header: Separated Time/Date & Status Badge */}
...
const styles = {
  ...
  sumRow: { display: 'flex', justifyContent: 'space-between', fontSize: '13px', marginBottom: '12px', paddingBottom: '8px', borderBottom: "1px solid var(--ov-on-line, rgba(255, 255, 255, 0.08))", opacity: 0.95 },
